...
# 基準: 300K, erate=0.002　ひずみ 15%
base = SimConfig(erate=0.002, np=4, max_strain=0.15)

# === 実験条件リスト: (説明文, replace(base, ...)) のタプル ===
experiments = [
    # --- 実験01,02の続き検証(xy60,z60で方位差組み合わせ) ---

    # 1. Cu(100)-Al(100) (コメントアウト: 既に実験01で実施)
    #    ("Size_LargeAll / 60x60_Z60",
    #    replace(base, target_xy=60.0, target_z=60.0, label="xy60_z60",miller1=(1, 0, 0), miller2=(1, 0, 0))),

    # 2. Cu(110)-Al(110)
    # ("Size_LargeAll / 60x60_Z60",
    # replace(base, target_xy=60.0, target_z=60.0, label="xy60_z60",miller1=(1, 1, 0), miller2=(1, 1, 0))),

    # 3. Cu(111)-Al(111)
    ("Size_LargeAll / 60x60_Z60",
     replace(base, target_xy=60.0, target_z=60.0, label="xy60_z60",miller1=(1, 1, 1), miller2=(1, 1, 1))),
]
